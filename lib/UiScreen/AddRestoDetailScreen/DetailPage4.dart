...
class _DetailPage4State extends State<DetailPage4> {
  List<CategoryModel> categoryList = [
    ...
    CategoryModel("Live Sports Screening", 0),
    CategoryModel("Luxury Dinner", 0),
    CategoryModel("Breakfast", 0),
    CategoryModel("Brunch", 0),
    CategoryModel("Bar", 0),
    CategoryModel("Rooftop", 0),
    CategoryModel("Nightlife", 0),
    CategoryModel("Dance floor", 0),
    CategoryModel("Pet Friendly", 0),
    CategoryModel("Work Friendly", 0),
    CategoryModel("Gluten free", 0),
    CategoryModel("Vegan Options", 0),
  ];

  // List<CategoryModel> categoryListSecond = [
  //   CategoryModel("Nightlife",0),
  //   CategoryModel("Dance floor",0),
  //   CategoryModel("Pet Friendly",0),
  //   CategoryModel("Work Friendly",0),
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          //       "FINISH".toUpperCase(),(){},blue_3653f6
          //   ),
          // ),
        ],
      ),
