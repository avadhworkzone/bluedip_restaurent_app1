...
class OrderDetailPickupFinal extends StatefulWidget {
  const OrderDetailPickupFinal({Key? key}) : super(key: key);

  @override
  State<OrderDetailPickupFinal> createState() => _OrderDetailPickupFinalState();
}

class _OrderDetailPickupFinalState extends State<OrderDetailPickupFinal> {
  @override
