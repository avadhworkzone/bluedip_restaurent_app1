...
class OrderDetailPreparing extends StatefulWidget {
  const OrderDetailPreparing({Key? key}) : super(key: key);

  @override
  State<OrderDetailPreparing> createState() => _OrderDetailPreparingState();
}

class _OrderDetailPreparingState extends State<OrderDetailPreparing> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CommonBlueButton(strREADY, () {}, blue_3653f6),
              ],
            ),
          ),
        ],
