...
class WalkThroughSecond extends StatefulWidget {
  const WalkThroughSecond({Key? key}) : super(key: key);

  @override
  State<WalkThroughSecond> createState() => _WalkThroughSecondState();
}

class _WalkThroughSecondState extends State<WalkThroughSecond> {
  @override
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Bye-bye commissions, hello profits!",
                    style: TextStyle(
                        color: Colors.white,
                ...
                Text(
                    "With Bluedip, you can say goodbye to commission fees and take control of your hard-earned money.",
                    style: TextStyle(
                        color: Colors.white,
