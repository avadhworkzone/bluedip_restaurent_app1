...
class WalkThroughThird extends StatefulWidget {
  const WalkThroughThird({Key? key}) : super(key: key);

  @override
  State<WalkThroughThird> createState() => _WalkThroughThirdState();
}

class _WalkThroughThirdState extends State<WalkThroughThird> {
  @override
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Get More Customers Through the Door.",
                    style: TextStyle(
                        color: Colors.white,
                ...
                Text(
                    "Bluedip's AI algorithms connect you with hungry diners in your area.",
                    style: TextStyle(
                        color: Colors.white,
