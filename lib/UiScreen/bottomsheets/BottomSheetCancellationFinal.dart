...
class BottomSheetCancellationFinal extends StatefulWidget {
  const BottomSheetCancellationFinal({Key? key}) : super(key: key);

  @override
  State<BottomSheetCancellationFinal> createState() =>
      _BottomSheetCancellationFinalState();
}

class _BottomSheetCancellationFinalState
    extends State<BottomSheetCancellationFinal> {
  // List<OfferModel> offerList = [
  //   OfferModel("Restaurant became busy"),
  //   OfferModel("Low on Staff"),
  //   OfferModel("Other Reason"),
  // ];
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Description
              Center(
                child: Text("Most of rejected customer do not \norder again.",
                    style: TextStyle(
                        color: Blue_5468ff,
              ...
              //                 mainAxisAlignment: MainAxisAlignment.start,
              //                 children: [
              //                   SvgPicture.asset(mySelectConsultation == i
              //                       ? icon_selected_radio
